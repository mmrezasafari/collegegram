...
export const Authenticate = () => {
  return (
    <div className="w-full h-full md:w-[500px] md:max-h-[700px] flex flex-col justify-center items-center bg-backgroundLight md:rounded-3xl py-16 max-md:px-6 md:shadow-formShadow gap-8">
      <img
